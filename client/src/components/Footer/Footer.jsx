    ...
    return <footer className="footer">
        <div className="footer-content">
            <div className="col">
                ...
                <div className="text">Our team is passionate about leveraging technology to revolutionize the agricultural industry. Our goal is to develop innovative solutions that will address the challenges faced by farmers and contribute to the stability and growth of farmers.</div>
            </div>
            <div className="col"><div className="title">
                ...
                <div className="c-item">
                    <FaLocationArrow/>
                    <div className="text">AgriMarket Pvt. Ltd.</div></div>
                    <div className="c-item">
                    <FaMobileAlt/>
